...
import (
	...
	ignitemodule "ignite/x/ignite"
	ignitemodulekeeper "ignite/x/ignite/keeper"
	ignitemoduletypes "ignite/x/ignite/types"
	nftmodule "ignite/x/nft"
	nftmodulekeeper "ignite/x/nft/keeper"
	nftmoduletypes "ignite/x/nft/types"
...
type App struct {
	*baseapp.BaseApp
	...
	IgniteKeeper ignitemodulekeeper.Keeper
...
func New(
	...
	app.IgniteKeeper = *ignitemodulekeeper.NewKeeper(
		appCodec,
		keys[ignitemoduletypes.StoreKey],
		keys[ignitemoduletypes.MemStoreKey],
		app.GetSubspace(ignitemoduletypes.ModuleName),
	)
	igniteModule := ignitemodule.NewAppModule(appCodec, app.IgniteKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(ignitemoduletypes.ModuleName)
