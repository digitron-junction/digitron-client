...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1}, []string{"nftmaker", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Nfts_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1}, []string{"nftmaker", "nfts"}, "", runtime.AssumeColonVerbOpt(true)))
)
