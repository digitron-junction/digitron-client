...
const colors = {
  layout: {
    ...
    sidebar: {
      ...
      menuItemBgActive: "linear-gradient(90deg, #3E97FF 1.49%, #9DC9FC 100%)",
...
export const OrionTheme = createTheme({
  ...
  colors: {
    gradients: {
      ...
      blue: "linear-gradient(90deg, #3E97FF 1.49%, #9DC9FC 100%)",
      // blue2: colors.gradients.blue2,
      // blue3: colors.gradients.blue3,
      // orange1: colors.gradients.orange1,
      // orange2: colors.gradients.orange2,
      purple: "linear-gradient(135.33deg, #8353C0 15.12%, #C6ABFF 80.77%)",
      // pink1: colors.gradients.pink1,
      yellow: "linear-gradient(269.95deg, #FFD422 0.02%, #FF7D05 97.45%)"
  ...
  components: {
    MuiBackdrop: {
      styleOverrides: {
        root: {
          backgroundColor: alpha(colors.layout.general.bodyBg, 0.5),
    ...
    MuiPaper: {
      styleOverrides: {
        root: {
          boxShadow: colors.shadows.main,
          borderRadius: 24,
          backgroundColor: 'rgba(252, 254, 254, 0.43)',
    ...
    MuiDialog: {
      styleOverrides: {
        paper: {
          backdropFilter: "blur(183px)",
          boxShadow: "0px 12px 55px rgba(72, 96, 132, 0.18)"
        },
      }
    },
    MuiDialogTitle: {
